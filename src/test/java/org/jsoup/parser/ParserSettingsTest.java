...
public class ParserSettingsTest {
    ...
    @Test
    @MultiLocaleTest public void caseSupport() {
    ...
    @Test
    @MultiLocaleTest public void attributeCaseNormalization() throws Exception {
    ...
    @Test
    @MultiLocaleTest public void attributesCaseNormalization() throws Exception {
        ParseSettings parseSettings = new ParseSettings(false, false);
